class Result:
    def __init__(self, opcode, w, carry, zero, alu_operation, alu_multibyte_result, jump_operation, jump_condition, mov_operation, destination_w, destination_flags, destination_memory, destination_registers, destination_ports, destination_index, ram_operand, duplicate_w):
        self.opcode = opcode
        self.w = w
        self.carry = carry
        self.zero = zero
